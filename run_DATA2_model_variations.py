...
mode = 'Lag'
fit_stru, sim_stru, sim_inter = solve_model(data_stru, mode, theta, sim_opt=False, B_form=1)
...
fit_stru_base2, sim_stru, sim_inter = solve_model(data_stru, mode, theta=theta0, sim_opt=False, B_form=1)
file_name = os.path.join(mode+"M1-fit.json")
store_json(file_name,fit_stru_base1)
